...
module.exports = (img) => {
	...
	// Sobelフィルタ適用
	const edgeXImg = conv.conv(img, image.sizes, sobelX, filterSizes, {mode:conv.EXPAND});
	const edgeYImg = conv.conv(img, image.sizes, sobelY, filterSizes, {mode:conv.EXPAND});
